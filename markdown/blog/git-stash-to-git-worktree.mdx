...
While on `feature/awesome-ui`, you realize you need to fix a bug or check something in `main`.

```bash
git stash    # your unfinished changes
git checkout main
# make the fix, test, commit
git checkout feature/awesome-ui
...
git worktree add ../feature-awesome-ui feature/awesome-ui

# If you need to drop into main
git worktree add ../main main

# Now you can work in main directory without affecting your feature worktree
cd ../main
# make bug fix
git commit -m "Fix bug"

# Switch back to your feature
cd ../feature-awesome-ui
...
- **Native:** `git worktree add ../feature-awesome-ui feature/awesome-ui`
- **WorktreeWise:** Click **New Worktree**, pick branch `feature/awesome-ui` → worktree is created instantly.
...
*(Insert screenshot: Worktree list or IDE integration)*
...
*(Insert screenshot: delete/prune options in UI)*
...
1. Begin working on `feature/awesome-ui`. Create a worktree via WorktreeWise.
...
*(Insert screenshots for: new worktree modal; worktree list showing both feature + main; delete/prune UI options.)*
...
👉 Try **WorktreeWise** today: [worktreewise.vercel.app](https://worktreewise.vercel.app)

Set up parallel worktrees, open your “main” and “feature” contexts concurrently, and leave git stash behind.
