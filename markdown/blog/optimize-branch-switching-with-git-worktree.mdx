...
date: 2025-10-02
coverImage: /images/blog/optimize.png
author: AMMACH MOHAMED AMINE
excerpt: Constantly switching branches? Discover how Git worktrees eliminate context switching and keep you in the zone.
---
...
![Create new Git Worktree](/images/blog/optimize/new-worktree.png)
...
![Create new Git Worktree from new Branch](/images/blog/optimize/new-branch-and-worktree.png)

### List all worktrees
- **Git**: `git worktree list`
- **WorktreeWise**: Open the dashboard for a visual overview.

![List Git Worktrees](/images/blog/optimize/list-worktrees.png)
...
![Delete Git Worktree](/images/blog/optimize/delete-worktree.png)
...
![Prune Git Worktrees](/images/blog/optimize/prune-worktrees.png)
