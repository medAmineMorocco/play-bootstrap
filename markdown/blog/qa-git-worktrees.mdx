...
![Git Worktrees Actions](/images/v1.1.0/16-worktree-actions.png)
...
![Git Worktrees Naming Pattern](/images/v1.1.0/20-worktree-change-pattern.png)
...
![Create Git Worktree](/images/v1.1.0/08-create-worktree-configured.png)
...
![List Git Worktree](/images/v1.1.0/04-worktree-overview.png)
