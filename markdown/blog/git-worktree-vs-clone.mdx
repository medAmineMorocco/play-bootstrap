...
Worktrees share the repository's Git object database and references, but each
worktree has its own checked-out files and index. Clones have separate Git
databases and can use different remotes or Git configuration.
...
Choose a clone when you need an independent repository, remote configuration,
credentials, or a disposable copy that can move separately. Choose a worktree
when you want fast parallel work on branches of the same local repository.
...
[See how to create a visual worktree](https://docs.worktreewise.com/git-worktrees/create)
or [start a free trial](/pricing?utm_source=blog&utm_medium=content_cta&utm_campaign=git-worktree-vs-clone).
