...
**Best for:** Clean Git UI with partial worktree awareness

Fork is a fast and clean Git GUI.

## Features
- High-performance UI
- Visual commit history
- Partial support for multiple working directories

## Limitations
- Worktree management is indirect
...
6. Code Generators
   ...
   Define reusable generators with structured inputs:
   ...
   Generate files directly inside any worktree.

7. Automatic Cleanup

   No more broken or stale worktrees.

   WorktreeWise handles pruning intelligently.

<Tip> If your workflow involves more than one active branch, WorktreeWise can save hours every week. </Tip>
